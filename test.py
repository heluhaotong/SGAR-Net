...
def get_args():
    ...
    parser.add_argument('--resume', default='/home/admin123/PycharmProjects/ASDA/saved_models/coco+/iou_best_checkpoint.pth', type=str, metavar='PATH',
                        help='path to latest checkpoint (default: none)')
    parser.add_argument('--pretrain', default='/home/admin123/PycharmProjects/ASDA/saved_models/coco+/iou_best_checkpoint.pth', type=str, metavar='PATH',
